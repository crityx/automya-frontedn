...
export default function RegistrationModal({ isOpen, onClose, onRegister }: RegistrationModalProps) {
  ...
  const handleGoogleAuth = async () => {
    ...
    try {
      ...
      await onRegister('user@google.com', 'google-auth');
      onClose();
    } catch (err) {
  ...
  const handleAppleAuth = async () => {
    ...
    try {
      ...
      // Simuler une connexion Apple réussie
      await onRegister('user@apple.com', 'apple-auth');
      onClose();
    } catch (err) {
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-3">
          <Button
            ...
            className="w-full justify-center gap-3 border-2 hover:border-primary"
          >
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-4 bg-white text-gray">ou</span>
          </div>
        </div>

        {/* Email Form (less prominent) */}
